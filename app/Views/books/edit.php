                    ...
                    <div class="card-body">
                        <form name="createForm" id="createForm" method="post" action="<?php echo base_url('books/edit/'.$book['id'])?>">
                            <div class="form-group">
                                <label>Name</label>
                                <input type="text" name="name" id="name" placeholder=" Enter Name" class="form-control <?php echo (isset($validation) && $validation->hasError('name')) ? 'is-invalid' : ''; ?>" value="<?php echo set_value('name',$book['title']); ?>">
                                <?php
                            ...
                            <div class="form-group">
                                <label>Author</label>
                                <input type="text" name="author" id="author" placeholder="Enter Author" class="form-control <?php echo (isset($validation) && $validation->hasError('author')) ? 'is-invalid' : ''; ?>" value="<?php echo set_value('author', $book['author']); ?>">
                                <?php
                            ...
                            <div class="form-group">
                                <label>ISBN No.</label>
                                <input type="text" name="isbn_no" id="isbn_no" class="form-control" placeholder="Enter ISBN No." value="<?php echo set_value('isbn_no', $book['isbn_no']); ?>">
